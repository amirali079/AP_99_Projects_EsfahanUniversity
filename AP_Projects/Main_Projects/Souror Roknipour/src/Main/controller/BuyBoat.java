...
public class BuyBoat implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> BoatType;
    ...
    void Buy(ActionEvent event) {
        if (City.Cost.Boat.getCost() > Country.country.inputCity.getInventory()) {
            ...
            if (!IsDigit(capacityTXT.getText())) {
                ...
                shippingPort.addboats(fuel.getValue(), BoatType.getValue(), Integer.parseInt(capacityTXT.getText()), companyTXT.getText(), depth.getValue(), oars.getValue());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        BoatType.getItems().addAll("Fishing Boats", "Bow Riders", "Cuddy Cabins", "Deck Boats", "Dinghies");

        oars.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(0, 8, 2, 1));
    ...
    public boolean notCompleted() {
        ...
        boolean type = BoatType.getSelectionModel().isEmpty();
